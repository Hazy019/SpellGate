...
*   **Floating Desktop Timer**: An always-on-top, draggable cyberpunk-styled timer that counts down earned time.
*   **Audio Pronunciation (TTS)**: Uses a built-in zero-lag Text-to-Speech engine to read out words and sentences.
...
## 🔐 Controls & Emergency Override

### Parent Override
If you need to bypass the lock screen or exit the application in an emergency:
*   Press **`Ctrl + Shift + P`** from the kiosk screen.
